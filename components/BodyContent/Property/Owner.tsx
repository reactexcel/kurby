        ...
        <Box sx={{ marginTop: 2 }}>
            ...
            <Box sx={classes.ownerCard}>
                ...
                <Box sx={{ padding: '15px', justifyContent: 'center', alignItems: 'flex-start', display: 'flex', flexFlow: 'column' }}>
                    <Typography variant="h5" component="h5" fontSize={'22px'}>
                        {owner?.names && owner?.names.length > 0 ? owner.names[0] : ''}
                    </Typography>
                    <Typography variant="h5" component="h5" fontWeight={350} fontSize={'18px'} sx={{ display: 'flex', alignItems: 'center', marginTop: 1 }}>
