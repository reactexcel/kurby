...
export const LegendSection = () => {
  return (
    <div className={styles.background}>
      ...
      <Paragraph
        text="Pay only for what you need. Select the features that align with your business goals and help you grow faster."
        className={styles.subTitle}
      />

      <div className={styles.switcherContainer}>
        <div className={`${styles.switcherTextContainer} ${styles.switcherTextContainerGreen}`}>
